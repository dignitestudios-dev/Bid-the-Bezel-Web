...
export const auctionWatches: AuctionWatch[] = [
  ...
  { watchId: "auc-002", name: "Omega Speedmaster  Professional", image: "https://images.unsplash.com/photo-1611992302108-9610ae48c552?w=400&h=400&fit=crop", basePrice: 7200, sellerId: "user-003", saleType: "auction", isAuthenticated: false, bidders: [{ userId: "user-004", bidAmount: 7500 }] },
  ...
  { watchId: "auc-005", name: "IWC Pilot's Watch 41", image: "https://images.unsplash.com/photo-1587836374615-910daa1ab5a9?w=400&h=400&fit=crop", basePrice: 6400, sellerId: "user-006", saleType: "auction", isAuthenticated: true, bidders: [] },
...
export const fixedPriceWatches: FixedPriceWatch[] = [
  ...
  { watchId: "fix-002", name: "Omega Seamaster 300M", image: "https://images.unsplash.com/photo-1606390041606-b4c7b0e0b069?w=400&h=400&fit=crop", price: 5600, sellerId: "user-003", saleType: "fixed-price", isAuthenticated: false },
  ...
  { watchId: "fix-004", name: "Tudor Black Fifty-Eight", image: "https://images.unsplash.com/photo-1624933766975-1c5e00024ffc?w=400&h=400&fit=crop", price: 3900, sellerId: "user-005", saleType: "fixed-price", isAuthenticated: false },
  { watchId: "fix-005", name: "Longines Moonphase", image: "https://images.unsplash.com/photo-1638035173732-d92fbb30e087?w=400&h=400&fit=crop", price: 3200, sellerId: "user-006", saleType: "fixed-price", isAuthenticated: true },
...
export const offerWatches: OfferWatch[] = [
  ...
  { watchId: "off-002", name: "Breguet Classique 5177", image: "https://images.unsplash.com/photo-1587836374615-910daa1ab5a9?w=400&h=400&fit=crop", expectedPrice: 11500, sellerId: "user-004", saleType: "taking-offer", isAuthenticated: false, offers: [] },
  ...
  { watchId: "off-006", name: "Blancpain Fifty Fathoms ", image: "https://images.unsplash.com/photo-1618838689992-bab0092e825c?w=400&h=400&fit=crop", expectedPrice: 13500, sellerId: "user-008", saleType: "taking-offer", isAuthenticated: false, offers: [] },
