...
const PlaceBidDialog = ({ open, setOpen, amount, user, isPending, onConfirm }: Props) => {
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogContent className="md:max-w-lg overflow-y-auto">
        ...
        <div className="w-full rounded-xl flex flex-col items-center bg-white p-4 py-8">
          <h1 className="text-xl font-semibold mb-6">Confirm Your Bid?</h1>
          ...
          <p className="text-sm text-gray-500 text-center mb-6">
            10% of your bid amount will be held in escrow
          </p>
          <div className="flex gap-4 w-full">
            ...
            <Button
              onClick={onConfirm}
              disabled={isPending}
              className="w-[50%] py-4 bg-[#415A77] hover:bg-[#0b1d2a] text-white"
            >
