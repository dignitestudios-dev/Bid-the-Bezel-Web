    ...
    <div className="w-[60%] space-y-8">
      <div>
        ...
        <h1 className="text-3xl">
          $765.76 <sub className="mb-4 text-xs">Starting Price</sub>
        </h1>
      </div>
      ...
      <div>
        ...
        <p>
          Adipiscing congue fringilla condimentum urna eget nunc at faucibus.
          Sed nibh hac turpis mi gravida velit. Sagittis risus nibh enim turpis
          orci.
        </p>
        <br />
        <p>
