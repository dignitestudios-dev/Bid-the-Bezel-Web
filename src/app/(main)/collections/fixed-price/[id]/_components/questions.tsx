...
const Questions = (props: Props) => {
  return (
    <div className="rounded-xl border border-[#E3E3E3]">
      <div className="bg-[#F7F7F7] rounded-t-xl font-semibold  flex gap-2 items-center px-4 py-3">
...
<path d="M3.14693 28.7971C1.82137 29.725 0 28.7767 0 27.1587V2C0 0.89543 0.895431 0 2 0H28C29.1046 0 30 0.895431 30 2V22C30 23.1046 29.1046 24 28 24H10.6304C10.2201 24 9.81969 24.1262 9.48352 24.3615L3.14693 28.7971Z" fill="#778DA9"/>
<path d="M11.3155 16L13.8915 6.2H17.1115L19.6875 16H17.7835L17.2515 13.844H13.7515L13.2195 16H11.3155ZM14.1855 12.136H16.8175L15.6275 7.362H15.3755L14.1855 12.136Z" fill="white"/>
</svg>
              ...
              <div>
                ...
                <div className="flex gap-2 text-xs" >
                  <h5>Watchseller</h5>
                  <span className="font-thin">12 Jan 2025, 12:30 Pm     Seller</span>
                </div>
              </div>
            </div>
          </div>
