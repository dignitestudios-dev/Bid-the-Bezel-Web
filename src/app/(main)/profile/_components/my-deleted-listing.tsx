...
const MyDeletedListing = ({ isFulfilled, setIsFulfilled, selectedTab }: { isFulfilled: boolean, setIsFulfilled: (value: boolean) => void, selectedTab: string }) => {
    const router = useRouter()
    const queryClient = useQueryClient()
    const { data, isLoading } = useGetMyDeletedActiveListing();
    return (
        <div>
...
export default MyDeletedListing;
