...
const OrderCompleted = (props: Props) => {
  return (
    <div className='flex justify-center min-h-screen items-center' >
        <div className='w-[50%] flex flex-col items-center'>
            <Image src={"/images/surprise.png"} alt='surpirce' width={200} height={200} />
            <div className='py-5 text-center'>
                <h1 className='text-3xl font-semibold' >Order done</h1>
                <p>Your new timepiece will arrive to buyer within 3-5 business days.</p>
            </div>
  ...
  <p className="text-xs text-gray-500 mb-4">
    Payment will arrive in your bank account once the buyer receives the watch.
  </p>
  ...
  <Button className='w-full '>Go Home</Button></Link>
