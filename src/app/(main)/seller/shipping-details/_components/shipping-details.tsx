...
const ShippingDetail = () => {
  ...
  const { data, isLoading } = useGetAuthenticateDetail(id as string)
  const { mutate: addShippigDetail, isPending } = useAddBuyerShippingDetails(id as string);
    ...
    <div className=" p-4 flex items-center justify-center">
      ...
      <div className="bg-white max-w-4xl w-full rounded-lg shadow-sm p-6">
        ...
        <div className="bg-gray-50 rounded-lg p-4 mb-6">
          <h3 className="text-sm font-semibold mb-3">{data?.data?.isAuthRequested ? "Our Info" : "Buyer Info"}</h3>
