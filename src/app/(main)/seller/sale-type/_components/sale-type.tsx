    ...
    <div className="md:h-screen flex  justify-center items-center">
      <div>
        ...
        <div className="flex md:flex-row flex-col py-4 gap-6">
          <div className="w-[400px] flex flex-col justify-between items-center p-5 h-[200px] bg-[#0D1B2A] rounded-xl">
          ...
          <div className="w-[400px] flex flex-col justify-between items-center p-5 h-[200px] bg-[#415A77] rounded-xl">
            <div className="flex flex-col items-center gap-4 text-white text-center">
